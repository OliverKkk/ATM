...
if ($tcash >= 1000)
{	
 $wdrawal="UPDATE tcash SET totalcash=(totalcash - 1000)where bankname='$bank' and client_id=$id";
mysql_query($wdrawal,$conn) or die("Insertion Failed:" . mysql_error()); 
$insert="INSERT INTO deposit values('','$bank','$id',1000,now())";
$rstt=mysql_query($insert) or die("Insertion Failed:" . mysql_error());
$insert="INSERT INTO withdraw values('','$bank','$id',1000,now())";
$rstt=mysql_query($insert) or die("Insertion Failed:" . mysql_error());
