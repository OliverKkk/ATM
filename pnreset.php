...
echo "<script language='javascript' type='text/javascript'> window.alert('Pin number successfully Reset'); </script>";
		echo "<script language='javascript' type='text/javascript'> location.href='atmwelcome.php' </script>";	
		
		
		}
		else{ 
		echo "<script language='javascript' type='text/javascript'> window.alert('Pin number not Reset'); </script>";
		echo "<script language='javascript' type='text/javascript'> location.href='pnreset.php' </script>";	
